...
define('BOT_TOKEN', '944453744:AAGhDVORYx9kqe-zfnVEoKbtnECWHPEqG_0');
...
function processMessage($message) {
  ...
  if (isset($message['text'])) {
    ...
    if (strpos($text, "Olá") === 0) {
		//envia a mensagem ao usuário
      sendMessage("sendMessage", array('chat_id' => $chat_id, "text" => 'Olá, '. $message['from']['first_name'].
		'! Eu sou um bot para automatizar lista de sinais, especialmente desenvolvido pelo grupo Reapers. Para ser incluído nessa jornada converse com @Coldreaper', 'reply_markup' => array(
